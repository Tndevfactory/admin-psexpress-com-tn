<template>
  <div>
    <div class="d-flex justify-space-between mr-6 mb-6">
      <v-btn color="secondary" text> Gestion des Categories</v-btn>
      ...
      <template v-slot:default>
        <thead>
          <tr>
            ...
            <th class="text-left grey white--text">Nom fr</th>
            <th class="text-left grey white--text">Nom en</th>
            <th class="text-left grey white--text">Nom ar</th>
            <th class="text-left grey white--text">icon</th>
